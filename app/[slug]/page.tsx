...
import { scoreEvent } from "@/lib/scorer"
...
import { ScoreBadge } from "@/components/oddex/score-badge"
...
export default async function EventPage({ params }: Props) {
  ...
  const signalScore = scoreEvent(event)
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                ...
                {signalScore && <ScoreBadge label={signalScore.label} score={signalScore.score} />}
              </div>
            </div>
          </div>
